...
def get_post_data(request):
    return {
        ...
        'Sub_Cluster': request.POST['Sub_Cluster'],
        'Congested':request.POST['Congested'],
        'Leakage':request.POST['Leakage'],
        'DCR': request.POST['DCR'],
        'AFR': request.POST['AFR'],
        'Misc': request.POST['Misc'],
        'Analysis': request.POST['Analysis'],
        'Last_updated': request.POST['Last_updated'],
        'Comments': request.POST['Comments'],
        'Optimization_Completed': request.POST['Optimization_Completed'],
        'Status': request.POST['Status'],
        'Perm_Solution': request.POST['Perm_Solution'],
        'Development_Priority': request.POST['Development_Priority'],
        'Cell_Split': request.POST['Cell_Split'],
        'Coverage_Strategy': request.POST['Coverage_Strategy'],
        'DART': request.POST['DART'],
        'Hardening_National': request.POST['Hardening_National'],
        'L1900_Capacity': request.POST['L1900_Capacity'],
        'L2100_Capacity': request.POST['L2100_Capacity'],
        'L700': request.POST['L700'],
        'Market_Infill': request.POST['Market_Infill'],
        'Modernization': request.POST['Modernization'],
        'New_Build_Infill': request.POST['New_Build_Infill'],
        'Replacement': request.POST['Replacement'],
        'ROB': request.POST['ROB'],
        'Rural_America': request.POST['Rural_America'],
        'Sector_Add': request.POST['Sector_Add'],
        'Small_Cell_Strategy': request.POST['Small_Cell_Strategy'],
        'T_Mobile_Store': request.POST['T_Mobile_Store'],
        'Venue_ACS': request.POST['Venue_ACS'],
        'Cell_Split_ID': request.POST['Cell_Split_ID'],
        }
